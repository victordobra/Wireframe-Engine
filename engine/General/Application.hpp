...
namespace wfe {
    ...
    typedef enum : uint32_t {
        ...
        /// @brief Triggered when the window enables/disables fullscreen.
    ...
    /// @brief The window fullscreen event info.
    struct WindowFullscreenEventInfo {
        /// @brief Whether fullscreen is enabled or not.
        bool8_t enabled;
    };
    ...
    /// @brief Enables fullscreen.
    void EnableFullscreen();
    /// @brief Disables fullscreen.
    void DisableFullscreen();
    /// @brief Gets whether fullscreen is enabled.
